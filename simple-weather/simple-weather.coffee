# SimpleWeather widget for Übersicht
# Author Ian W. Nicholson
# Modified by Jacque Wilson
# OhanaCode 
# ------------------------------ CONFIG ------------------------------

# openweathermap.org api key (Key below is a fake as an exmple)
apiKey: '2a4a3caf68b431e26799ad584144246e'
...
style: """
	...
	@font-face
		font-family Weather
		src url(./simple-weather/iconsWX.svg) format('svg')
	#left
		padding-left 80px
	#temp
		font-size 2em
